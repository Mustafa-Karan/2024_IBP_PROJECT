...
--
-- Anamakine: localhost
-- Üretim Zamanı: 26 May 2024, 13:29:30
...
--
-- Tablo için tablo yapısı `add_book`
--
...
--
-- Tablo için tablo yapısı `finezone`
--
...
--
-- Tablo için tablo yapısı `issue_book`
--
...
--
-- Tablo için tablo yapısı `lib_registration`
--
...
--
-- Tablo döküm verisi `lib_registration`
--

INSERT INTO `lib_registration` (`id`, `name`, `username`, `password`, `email`, `phone`, `address`, `photo`, `status`) VALUES
(1, 'Mustafa Karan', 'admin', 'admin', 'mustafakaran@gmail.com', '01721585268', 'ankara', 'upload/1553532571.jpg', '');
...
--
-- Tablo için tablo yapısı `request_books`
--
...
--
-- Tablo döküm verisi `request_books`
--
...
--
-- Tablo için tablo yapısı `std_registration`
--
...
--
-- Tablo döküm verisi `std_registration`
--
...
(5, 'Mostafizur Rahman', 'mustafa', '123456', 'mstfa22@gmail.com', '01997259865', '8th', 'CSE', '14/15', '14502000020', 'sonadanga 2nd phase', 'student', 'upload/1568958905.jpg', 'yes', 'gfhtr4ghtrgfbvf', 'yes'),
...
--
-- Tablo için tablo yapısı `t_issuebook`
--
...
--
-- Tablo döküm verisi `t_issuebook`
--
...
--
-- Tablo için tablo yapısı `t_registration`
--
...
--
-- Tablo döküm verisi `t_registration`
--
...
(1, 'Mustafa Karan', 'mustafa22', '123456', 'CSE', 'nahid001@gmail.com', '01721455456', '1001', 'Sonadanga 2nd phase, khulna', 'teacher', 'upload/avatar.jpg', 'yes', 'dsfdfsghrfjhyetryt5ergbfvh', 'yes'),
...
--
-- Tablo için indeksler `add_book`
--
ALTER TABLE `add_book`
  ADD PRIMARY KEY (`id`);

--
-- Tablo için indeksler `finezone`
--
ALTER TABLE `finezone`
  ADD PRIMARY KEY (`id`);

--
-- Tablo için indeksler `issue_book`
--
ALTER TABLE `issue_book`
  ADD PRIMARY KEY (`id`);

--
-- Tablo için indeksler `lib_registration`
--
...
--
-- Tablo için indeksler `request_books`
--
ALTER TABLE `request_books`
  ADD PRIMARY KEY (`id`);

--
-- Tablo için indeksler `std_registration`
--
ALTER TABLE `std_registration`
  ADD PRIMARY KEY (`id`);

--
-- Tablo için indeksler `t_issuebook`
--
ALTER TABLE `t_issuebook`
  ADD PRIMARY KEY (`id`);

--
-- Tablo için indeksler `t_registration`
--
...
--
-- Tablo için AUTO_INCREMENT değeri `add_book`
--
ALTER TABLE `add_book`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- Tablo için AUTO_INCREMENT değeri `finezone`
--
ALTER TABLE `finezone`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- Tablo için AUTO_INCREMENT değeri `issue_book`
--
ALTER TABLE `issue_book`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- Tablo için AUTO_INCREMENT değeri `lib_registration`
--
ALTER TABLE `lib_registration`
...
--
-- Tablo için AUTO_INCREMENT değeri `request_books`
--
ALTER TABLE `request_books`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- Tablo için AUTO_INCREMENT değeri `std_registration`
--
ALTER TABLE `std_registration`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;

--
-- Tablo için AUTO_INCREMENT değeri `t_issuebook`
--
ALTER TABLE `t_issuebook`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- Tablo için AUTO_INCREMENT değeri `t_registration`
--
ALTER TABLE `t_registration`
